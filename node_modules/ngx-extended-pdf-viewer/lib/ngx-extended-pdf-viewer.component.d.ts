...
export declare class NgxExtendedPdfViewerComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
    ...
    relativeCoordsSupport: RelativeCoordsSupport | undefined;
    ...
    get showScrollingButton(): any;
    set showScrollingButton(val: any);
    private _showSpreadButton;
    get showSpreadButton(): any;
    set showSpreadButton(val: any);
    ...
    constructor(ngZone: NgZone, platformId: any, notificationService: PDFNotificationService, location: Location, elementRef: ElementRef, platformLocation: PlatformLocation, cdr: ChangeDetectorRef, service: NgxExtendedPdfViewerService);
    ...
    registerAcroformAnnotations(sortedAnnotations: Array<Annotation>): void;
